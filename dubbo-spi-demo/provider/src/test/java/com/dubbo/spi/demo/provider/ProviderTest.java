...
public class ProviderTest {
    ...
    public void start_provider_1() throws Exception {
        ...
        context.start();
        System.err.println("Dubbo Provider 1 started successfully...");
        System.in.read();
    }
    ...
    public void start_provider_2() throws Exception {
        ClassPathXmlApplicationContext context =
                new ClassPathXmlApplicationContext(new String[] {"dubbo-provider2.xml"});
        context.start();
        System.err.println("Dubbo Provider 2 started successfully...");
        System.in.read();
    }
}
